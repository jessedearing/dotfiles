...
export PATH=$PNPM_HOME:${KREW_ROOT:-$HOME/.krew}/bin:${NVM_DIR}/versions/node/v${CURRENT_NODE_VERSION}/bin:$HOME/.pyenv/bin:$HOME/.fzf/bin:$HOME/.yarn/bin:$HOME/go/bin:/opt/homebrew/opt/openjdk/bin:/usr/local/bin:/usr/local/sbin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/X11/bin:/usr/local/opt/perl/bin:$PATH
